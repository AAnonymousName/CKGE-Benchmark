...
def split_data(s0,s1,s2,data_name):
    ...
    with open('../data/PS-CKGE/{}/2/train.txt'.format(data_name), 'w') as f:
        for line in train:
            f.write(line + '\n')
    with open('../data/PS-CKGE/{}/2/valid.txt'.format(data_name), 'w') as f:
        for line in valid:
            f.write(line + '\n')
    with open('../data/PS-CKGE/{}/2/test.txt'.format(data_name), 'w') as f:
        for line in test:
            f.write(line + '\n')
